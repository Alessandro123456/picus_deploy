                  ...
                  <Row>
                    ...
                    <Col sm='6'>
                      <FormGroup>
                        ...
                        <Input id="inserimento_locale_superficie" type="range" min="0" max="50" step="5" defaultValue="10" onInput={this.onInputSuperficie.bind(this)} /> {this.state.range_superficie}
                  ...
                  <Row>
                    ...
                    <Col sm='6'>
                      <FormGroup>
                        ...
                        <Input id="inserimento_locale_capienza" type="range" min="0" max="250" step="1" defaultValue="25" onInput={this.onInputCapienza.bind(this)} /> {this.state.range_capienza}
